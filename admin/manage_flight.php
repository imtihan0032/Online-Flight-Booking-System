			...
			<div class="row">
				<div class="col-md-6">
					<div class="">
						...
						<select name="type" id="type" class="custom-select browser-default select2">
							<option value="Economy" <?php echo isset($type) and $type == 'Economy' ? "selected" : '' ?>>Economy</option>
							<option value="Premium Economy"  <?php echo isset($type) and $type == 'Premium Economy' ? "selected" : '' ?>>Premium Economy</option>
							<option value="Business"  <?php echo isset($type) and $type == 'Business' ? "selected" : '' ?>>Business</option>
							<option value="First Class"  <?php echo isset($type) and $type == 'First Class' ? "selected" : '' ?>>First Class</option>
						</Select>
					</div>
				</div>
			</div>
